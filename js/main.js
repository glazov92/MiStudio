...
function getLinks() {
    return (window.MiEditorData && window.MiEditorData.links) || {};
}
...
function socialLinksHtml(iconSize = 18) {
    ...
    return `
        <a href="${links.vk || CONFIG.vkUrl}" target="_blank" rel="noopener" aria-label="ВКонтакте">
        ...
        <a href="${links.tg || CONFIG.tgUrl}" target="_blank" rel="noopener" aria-label="Telegram">
        ...
        <a class="socials__dikidi" href="${links.dikidi || CONFIG.dikidiUrl}" target="_blank" rel="noopener" aria-label="Онлайн-запись в DiKiDi">
