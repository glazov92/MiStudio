const CONFIG = {
    ...
    leadWebhookUrl: 'https://script.google.com/macros/s/AKfycbxHCvTiIsjHHaluHGnObSLd6mPVy0MpL_3BC0yZ5HVwBRC1VHc3t4vkGvXSkeNjNOV9fA/exec', // заявки → беседа VK + email (GAS-вебхук, корпоративная почта)
